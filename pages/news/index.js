  ...
  return (
    <section className="relative h-full">
      ...
      <div className='flex px-3 absolute bottom-0 left-0 right-0 bg-white'>
        <p className='text-lg leading-7 px-2 pt-3 md:pb-9 pb-3 uppercase NeueHaasRoman'>
          Victoria, Australia
        </p>
        <p className='text-lg leading-7 border-l border-black/80 px-2 pt-3 md:pb-9 pb-3 uppercase NeueHaasRoman'>
          12:31 PM
        </p>
      </div>
    </section>
