  ...
  return (
    <section className="relative h-sccreen">
      ...
      <div className='flex px-3 absolute bottom-0 left-0 right-0 bg-white'>
        <p className='text-xs leading-4 px-2 pt-2.5 pb-9 uppercase NeueHaasRoman'>
          Victoria, Australia
        </p>
        <p className='text-xs leading-4 border-l border-black/80 px-2 pt-2.5 pb-9 uppercase NeueHaasRoman'>
          12:31 PM
        </p>
      </div>
    </section>
